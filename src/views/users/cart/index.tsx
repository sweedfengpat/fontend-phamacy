        ...
        <TableBody>
          {rows.map((row: any, index: any) => (
              ...
              <TableCell align="center">
                <Button sx={{borderRadius: '20px'}} variant="outlined" color='error' onClick={() => {minusAmount(row.productAmount, row.productAmountData, row.id, row.productPrice)}}><RemoveCircleIcon /></Button>
                  <TextField type="number" variant="outlined" value={row.productAmount} sx={{marginRight: '10px', marginLeft: '10px' ,width :'50px'}} 
                  InputProps={{
                    readOnly: true,
                  }} />
                <Button sx={{borderRadius: '20px'}} variant="outlined" color='success' onClick={() => {addAmount(row.productAmount, row.productAmountData, row.id, row.productPrice)}}><AddCircleIcon /></Button>
                </TableCell>
              <TableCell align="center" id='total'>{total}</TableCell>
              <TableCell align="center">
              <Button sx={{borderRadius: '20px'}} variant="contained" color='error' onClick={() => {delete_item(row.id)}}><DeleteIcon /></Button>  
              </TableCell>
            </TableRow>
